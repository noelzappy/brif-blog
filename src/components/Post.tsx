...
export default function Post({ post }: PostProps) {
  ...
  return (
    <>
      <article
        key={post.id}
        className="flex max-w-xl flex-col items-start justify-between border-b border-gray-200 py-4"
      >
        <div
          className="relative h-[500px] w-full overflow-hidden 
          rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 
        lg:aspect-w-1 group-hover:opacity-75 sm:h-[300px] lg:h-[500px] md:h-[400px]"
        >
          <img
            src={post.image}
            alt={post.title}
